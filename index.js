...
client.on('ready', async () => {
  ...
  console.log(`Made by Domino`)
  console.log(`Support | https://discord.gg/hpX3k2XYGg`)
  client.user.setActivity(config.status.name, { type: config.status.type.toUpperCase(), url: "https://twitch.tv/#" })
});
...
> \`${prefix}setstaff\` - set staff roles`)
  ...
  if (command == prefix + 'send' || command == prefix + 'ticket') {
    ...
    .setEmoji('🟠')
    .setValue("hlp")
    .setDescription('Use this to order a bot/server')  
    ...
    let embed = new Discord.MessageEmbed()
      .setTitle(args)
      .setDescription("**Ordering**\n\n **Start of ticket**\n ) Specify what you want\n\n ) Specify what payment method you will use\n\n ) Bot name, avatar, bio\n\n **Custom bot**\n ) What commands you want\n\n**Shop info <#993646882159083661> **")
